...
admin.site.site_header = "FApp"
admin.site.site_title = "FApp Admin Portal"
admin.site.index_title = "FApp Admin"

# swagger
api_info = openapi.Info(
    title="FApp API",
    default_version="v1",
    description="API documentation for FApp App",
)
